...
if (isset($_POST['id']) && isset($_POST['name']) && isset($_POST['place']) && isset($_POST['start_date']) && isset($_POST['num_of_days'])
    ...
    // create a new user
    $event = $db->updateEvent($id, $name, $place, $start_date, $num_of_days, $budget, $moderator, $contact, $details);
